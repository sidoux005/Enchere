...
if($db->exec($query)){
	echo ' <div class="alert alert-success">
        <strong><font Color="blue"><h3>Votre Image est sauvegardé ave succès</h3></font></strong> <marquee><font Color="red"><h2>Si dans 10 minutes aucune proposition de prix n’est soumise, votre image va être supprimée.</h2></font><marquee>
      </div>';
}else{
	echo "error in query...";
}
